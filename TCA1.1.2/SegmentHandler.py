...
class SegmentHandler:
    ...
    def _epoch(self, sample_list, lr_w, lr_p, lr_s, desc, freeze_connections=False):
        ...
        # need to be refreshed that often. Throttle to roughly every 0.5% of
        # the epoch's samples instead; a final unconditional reconnect after
        # the loop (below) still guarantees topology matches the true final
        # positions regardless of where this lands.
        reconnect_every = max(1, round(0.005 * len(sample_list))) if sample_list else 1
